...
def get_parser():
    ...
    # torch.distributed.launch/torchrun will pass --local_rank or --local-rank; accept to avoid DictAction parsing crash
...
def parse_cfg(args):
    ...
    if args.config and exists(args.config) and os.path.isfile(args.config):
